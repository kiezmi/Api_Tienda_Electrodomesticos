...
/**
 * Unit test for simple Ejecutable.
 */
public class Test_Electrodomestico {
    ...
    public void testComprobarColor() {
        System.out.println("Testeo del color");
        Electrodomestico bateria = new Electrodomestico();
        System.out.println(bateria.getColor());
        assertEquals(Electrodomestico.Colores.BLANCO, bateria.getColor());
    }
